...
import com.example.login.AddNewContact
...
class ContactManager: ListActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val footerView: View= LayoutInflater.from(this@ContactManager).inflate(R.layout.activity_main,listView,false)
            ...
            mNotificationReceiverPendingIntent = PendingIntent.getBroadcast(
               this@ContactManager, 0, mNotificationReceiverIntent, 0
                ...
                mAlarmManager?.setRepeating(
                    ...
                    //change to repeat_interval in order to have true implementation
                    //REPEAT_INTERVAL is for testing so you don't have to wait a whole day to see if it works
